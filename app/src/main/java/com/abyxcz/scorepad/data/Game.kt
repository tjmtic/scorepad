...
sealed interface Game {
    ...
    data class Tally(val title: String, override val defaults: Pair<String, Int?> = Pair("Tally", R.mipmap.tally)) : Game
    data class TicTacToe(val players: Int, override val defaults: Pair<String, Int?> = Pair("TicTacToe", R.mipmap.bg1)): Game
    data class Dominos(val players: Int, override val defaults: Pair<String, Int?> = Pair("Dominos", R.mipmap.bg2)): Game
    data class Basketball(val players: Int, val names: String, override val defaults: Pair<String, Int?> = Pair("Basketball", R.mipmap.basketball)): Game
